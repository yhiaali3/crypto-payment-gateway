...
# Start with PM2
pm2 start dist/server/node-build.mjs --name cryptogate
```
...
- Included: `client/`, `server/`, `shared/`, `docs/`, `assets/screenshots/` (SVGs), `INSTALLATION_GUIDE.md`, `LICENSE.txt`, `README.md`, `package.json` and other runtime files.
